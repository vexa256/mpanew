        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-7">
                ...
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-danger">Reported indicators that have been returned</span>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-circle symbol-40px me-3">
                                                    <img src="https://www.svgrepo.com/show/474712/warning.svg"
                                                        class="" alt="">
                                                </div>
                                        ...
                                        <td class="text-end">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#CRFPDO{{ $data->indicatorReportID }}">
                                                Comments
                                            </button>
                                        ...
                                        <td class="float-end text-end border-0">
                                            ...
                                            <form id="WarnBeforeSubmit" action="{{ route('FixReturned') }}" method="GET">
                                                @csrf
                            ...
                            @isset($CRPITM)
                                @foreach ($CRPITM as $data)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#CRPITM{{ $data->indicatorReportID }}">
                                                Comments
                                            </button>
...
@include('Returned.Comments')
@include('Returned.Comments2')
