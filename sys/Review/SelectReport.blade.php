<div class="col-12  mb-md-5 mb-xl-10">
    ...
    <div class="card card-flush h-lg-50">
        ...
        <div class="card-header pt-5">
            <!--begin::Title-->
            <h3 class="card-title text-gray-800 fw-bold">Select Report to Review (Only Reports With Pending
                Reported
                Indicators Are
                Shown)</h3>
            <!--end::Title-->
            ...
            @isset($DataBaseData)
                @foreach ($DataBaseData->unique('Entity') as $data)
                    ...
                    <div class="d-flex flex-stack">
                        <!--begin::Section-->
                        <a href="{{ route('PendingReportViewIndicators', ['Entity' => $data->Entity, 'ReportYear' => $data->ReportingYear, 'RID' => $data->RID]) }}"
                            class="text-primary fw-semibold fs-3 me-2">{{ $data->ReportTitle }}
