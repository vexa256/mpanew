        ...
        <div class="card card-flush h-xl-100">
            ...
            <div class="card-header pt-7">
                ...
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold text-gray-800">Reported Indicators Pending Review</span>
                            ...
                            @isset($CRFPDO)
                                @foreach ($CRFPDO as $data)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <span class="text-danger fw-bold d-block mb-1 fs-6">Reviewed:
                                                {{ $data->ApprovalStatus }}</span>

                                        </td>

                                        <td class="float-end text-end border-0">
                                            <a href="{{ route('ReviewIndicator', ['Entity' => $Entity, 'RID' => $RID, 'IID' => $data->IID]) }}"
